...
After you've successfully generated a plan, you can begin [Applying a plan](/docs/hpc-spectrum-scale?topic=hpc-spectrum-scale-applying-plan&interface=ui) to deploy your {{site.data.keyword.cloud_notm}} resources to build a {{site.data.keyword.scale_short}} cluster instance.
...
After you've successfully generated a plan, you can begin [Applying a plan](/docs/hpc-spectrum-scale?topic=hpc-spectrum-scale-applying-plan&interface=cli) to deploy your {{site.data.keyword.cloud_notm}} resources to build a {{site.data.keyword.scale_short}} cluster instance.
...
2. Copy and paste the [Generate a plan using {{site.data.keyword.bpshort}} Python API](/docs/hpc-spectrum-scale?topic=hpc-spectrum-scale-generate-plan&interface=api#example-request-generate) example request to your Python file.
...
4. Inside the `schematics_service.plan_workspace_command` function, provide the following parameters:
  * Provide the workspace ID that you created in the [Create a workspace](/docs/hpc-spectrum-scale?topic=hpc-spectrum-scale-creating-workspace&interface=api) task or from the {{site.data.keyword.cloud_notm}} console for {{site.data.keyword.bpshort}}, for example, `us-south.workspace.Terraform-Schematics-Python-Workspace.b3bbc9f5`.
...
5. Make sure to update the required property values. For more information, see [Deployment values](/docs/hpc-spectrum-scale?topic=hpc-spectrum-scale-deployment-values).
...
8. If you want to check the logs of the action, see [Retrieving action logs with {{site.data.keyword.bpshort}} API](/docs/hpc-spectrum-scale?topic=hpc-spectrum-scale-retrieve-action-logs) to retrieve the logs. The response contains the status of the action, and it appears in either a `COMPLETED` or `FAILED` state.
...
After you've successfully generated a plan, you can begin [Applying a plan](/docs/hpc-spectrum-scale?topic=hpc-spectrum-scale-applying-plan&interface=api) to deploy your {{site.data.keyword.cloud_notm}} resources to build a {{site.data.keyword.scale_short}} cluster instance.